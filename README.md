...
```kotlin
dependencies {
    implementation("com.github.QWEA0:liquidglass:v2.0.7")
}
```
...
`com.github.QWEA0:Liquid-Glass-Android:v2.0.7` — either resolves to the library. The
...
同一个 AAR 还有一份别名 `com.github.QWEA0:Liquid-Glass-Android:v2.0.7`，两者等价。
